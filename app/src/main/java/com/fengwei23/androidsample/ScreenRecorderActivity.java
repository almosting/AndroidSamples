...
public class ScreenRecorderActivity extends AppCompatActivity
            ...
            case R.id.record_button:
              if (checkPermissionWriteExternalStorage() && checkPermissionAudio()) {
                if (isChecked) {
                  ...
                  final Intent intent =
                      new Intent(ScreenRecorderActivity.this, ScreenRecorderService.class);
  ...
  private static final class MyBroadcastReceiver extends BroadcastReceiver {
    private final WeakReference<ScreenRecorderActivity> mWeakParent;

    public MyBroadcastReceiver(final ScreenRecorderActivity parent) {
